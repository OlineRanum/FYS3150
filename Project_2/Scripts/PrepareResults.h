...
public:
    ...
    void Prepare_results_2B_eigenvalues(int N, double* lambda_jacobi, double* lambda_analytical, double* lambda_arma);
    ...
    void Prepare_results_2F_egienvectors(int N,  mat I, double* lambda_jacobi_2e, string omega_value);
