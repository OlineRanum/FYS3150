...
\hline 
	\end{tabular}
	\captionof{table}[foo]{The energy eigenvalue for the ground state of a two-electron system in three dimensions. The value is an average off 10 independent calculations of the eigenvalue.\label{tab2}}
\end{figure}
